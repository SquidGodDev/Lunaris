...
func play_se_rand_pitch(sound_effect : String, pitch_variance : float):
	var rand_pitch = rng.randf_range(1 - pitch_variance, 1 + pitch_variance)
	self.play_se(sound_effect, 0.0, -81, rand_pitch)
